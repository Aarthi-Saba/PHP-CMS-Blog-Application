    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                       <?php $username = GetUserFullName();?>
                        <h3 class="page-header">Posts by <?php echo $username ?></h3>
...
if(isset($_POST['checkBoxArray']))
{
    ...
    */
    ...
    {
        $clonebulkquery = "INSERT INTO POST (Post_Category_Id,Post_Title,Post_Author_User_Name,Post_Author,Post_Date,
                           Post_Image,Post_Content,Post_Tags,Post_Comment_Count,Post_Status) SELECT Post_Category_Id, Post_Title,Post_Author_User_Name,Post_Author,Post_Date,Post_Image, Post_Content,Post_Tags,
                           Post_Comment_Count,Post_Status FROM Post WHERE ID IN ($bulkids)";
                       ...
                       <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                           <?php 
                            ...
                            $postjoinquery = "SELECT POST.Id,POST.Post_Category_Id,POST.Post_Title,POST.Post_Author,
                                             POST.Post_Date,POST.Post_Image,POST.Post_Content,POST.Post_Tags,
                                             POST.Post_Comment_Count,POST.Post_Status,POST.Post_Views_Count,
                                             CATEGORY.CategoryId,CATEGORY.CategoryTitle FROM POST LEFT JOIN CATEGORY
                            ...
                            while($row = mysqli_fetch_assoc($allposts))
                            {
                                ...
                                echo "<td>$posttags</td>";
                                echo "<td>$postcomments <a href='AdminComments.php?cp_id={$postid}'>Comments</a></td>";
                                echo "<td>$postdate</td>";
                                echo "<td>$postviewcount :<a href='AdminPosts.php?reset={$postid}'>Reset</a></td>";
...
$(document).ready(function(){
    $(".delete_link").on('click',function(){
        ...
        var delete_url = "AdminPosts.php?delete="+ id +" ";
